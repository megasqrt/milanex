...
?>
<tr>
	<td><a href="index.php?page=trade&market=<?php echo $market_id; ?>"><?php echo $row["Name"];?></a></td><td class="b1"><?php echo  sprintf("%.8f",$amount); ?></td><td class="b1"><?php echo $pending; ?></td><td><a href="index.php?page=deposit&id=<?php echo $row["Id"]; ?>">Deposit</a></td><td><a href="index.php?page=withdraw&id=<?php echo $row["Id"]; ?>">Withdraw</a></td>
</tr>
<?php
}
?>
