...
$feecost = mysql_result($SQL2, 0,"Fee");
				...
				<div id="col1">
					...
					<div id="sellform">
						...
						<form action="index.php?page=trade&market=<?php echo $id; ?>" method="POST" autocomplete="off" history="off" onsubmit="document.getElementById('#Sell').disabled = 1;"> 
							...
							<input class="fieldsmall" type="text" style="width:150px;" name="Amount" onBlur="calculateFees1(this)" id="Amount" placeholder="Amount(<?php echo $name; ?>)"/><br/>
							<input class="fieldsmall" type="text" style="width:150px;" name="price1" onBlur="calculateFees1(this)" id="price1" placeholder="Price(MLC)"/><br/>
							<input class="fieldsmall" type="text" style="width:150px;" id="earn1" placeholder="Receive(MLC)" readonly /></br>
				...
				<div id="col2">
					...
					<div id="buyform">
						...
						<form action="index.php?page=trade&market=<?php echo $id; ?>" method="POST" autocomplete="off" history="off" onsubmit="document.getElementById('#Buy').disabled = 1;">
							...
							<input class="fieldsmall" type="text" style="width:150px;" name="Amount2" onBlur="calculateFees2(this)" id="Amount2" placeholder="Amount(MLC)"/><br/>
							<input class="fieldsmall" type="text" style="width:150px;" name="price2" onBlur="calculateFees2(this)" id="price2" placeholder="Price(MLC)"/><br/>
							<input class="fieldsmall" type="text" style="width:150px;" id="fee2" placeholder="Receive (<?php echo $name;?>)" readonly /><br/>
